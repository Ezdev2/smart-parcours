<template>
    <section class="relative h-screen flex items-center justify-center text-center overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-indigo-100 to-white-100 opacity-50 animate-gradient-shift">
        </div>
        ...
        <div class="flex flex-col items-center gap-4 relative z-10 text-white max-w-6xl px-4 animate-fade-in-up">
            <div class="absolute top-[-200px] md:block hidden">
                <HeroTwoAnimated class="w-[1000px] opacity-10"/>
            </div>
            ...
            <div class="flex lg:flex-row flex-col items center gap-6 lg:w-3/4">
                <button @click="$emit('add-school')"
                    class="flex gap-4 items-center rounded-full w-full justify-center text-white text-md font-medium bg-indigo-600 px-8 md:py-5 py-3 hover:shadow-xl transform hover:-translate-y-1 transition duration-300">
                ...
                <router-link 
                    ...
                    class="flex gap-4 items-center rounded-full w-full justify-center text-indigo-600 text-md font-medium bg-white border px-8 md:py-5 py-3 hover:shadow-xl transform hover:-translate-y-1 transition duration-300"
                >
